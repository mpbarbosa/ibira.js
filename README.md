...
<script src="https://cdn.jsdelivr.net/npm/ibira.js@0.4.11-alpha/dist/index.mjs"></script>

<!-- Load with SRI (Subresource Integrity) for security -->
<script src="https://cdn.jsdelivr.net/npm/ibira.js@0.4.11-alpha/dist/index.mjs"
...
```html
<script type="module">
  import { IbiraAPIFetcher } from 'https://cdn.jsdelivr.net/npm/ibira.js@0.4.11-alpha/dist/index.mjs';
</script>
```

### Version Options

- **Specific version:** `@0.4.11-alpha` (recommended for production)
