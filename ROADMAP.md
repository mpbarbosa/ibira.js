...
> **Current version:** 0.4.12-alpha — v0.4.x Beta Preparation in progress
...
| **0.4.12-alpha** | Request/response interceptors, pluggable retry strategy, `DefaultCache<T>` generics, TypeScript ESLint coverage, 251 tests |
