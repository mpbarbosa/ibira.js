...
> **Current version:** 0.4.19-alpha — v0.4.x Beta Preparation in progress
...
| **0.4.19-alpha** | Request/response interceptors, pluggable retry strategy, `DefaultCache<T>` generics, TypeScript ESLint coverage, 251 tests |
