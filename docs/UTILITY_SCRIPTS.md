...
Specific Version (Production):
  Main: https://cdn.jsdelivr.net/gh/mpbarbosa/ibira.js@0.4.18-alpha/src/index.js
  ...
...
./cdn-delivery.sh | grep "@0.4.18-alpha"
```
