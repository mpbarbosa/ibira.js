...
- **UPDATED**: ROADMAP.md — v0.4.12-alpha items marked complete; completed table updated
...
- **ADDED**: Updated CDN delivery — jsDelivr URLs now reference `dist/index.mjs` and version `0.4.12-alpha` for both script and module usage; documentation and examples updated accordingly
