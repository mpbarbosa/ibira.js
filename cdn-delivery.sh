...
echo ""
echo "Load latest v0.2.x (patch updates):"
echo "https://cdn.jsdelivr.net/gh/${GITHUB_USER}/${GITHUB_REPO}@0.2/${MAIN_FILE}"
echo ""
...
echo "https://cdn.jsdelivr.net/gh/${GITHUB_USER}/${GITHUB_REPO}@${PACKAGE_VERSION}/src/index.min.js"
echo ""
...
echo "https://cdn.jsdelivr.net/combine/gh/${GITHUB_USER}/${GITHUB_REPO}@${PACKAGE_VERSION}/src/core/IbiraAPIFetcher.js,gh/${GITHUB_USER}/${GITHUB_REPO}@${PACKAGE_VERSION}/src/core/IbiraAPIFetchManager.js"
echo ""
...
https://cdn.jsdelivr.net/gh/${GITHUB_USER}/${GITHUB_REPO}@0.2/${MAIN_FILE}
