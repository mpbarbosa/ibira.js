...
README.md                    | @0.4.6-alpha       | @0.4.3-alpha       | ✗ MISMATCH
docs/API.md                  | 0.4.6-alpha        | 0.4.6-alpha        | ✓ OK
```
...
✅  Committed: chore(version): sync all version strings to 0.4.6-alpha
════════════════════════════════════════════
```
...
```
✅  sync-version: all version strings already agree with package.json (0.4.6-alpha)
