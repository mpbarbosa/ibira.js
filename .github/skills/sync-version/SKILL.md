...
README.md                    | @0.4.19-alpha       | @0.4.3-alpha       | ✗ MISMATCH
docs/API.md                  | 0.4.19-alpha        | 0.4.19-alpha        | ✓ OK
```
...
════════════════════════════════════════════
Canonical version: 0.4.19-alpha
─────────────────────────────────────────────
File                         Status
...
✅  Committed: chore(version): sync all version strings to 0.4.19-alpha
════════════════════════════════════════════
```
...
```
✅  sync-version: all version strings already agree with package.json (0.4.19-alpha)
